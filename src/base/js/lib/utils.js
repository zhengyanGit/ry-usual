var own = {
	...
	dataTime: function (timeStr, unit) {
		//shijianchuo是整数，否则要parseInt转换
        if (timeStr == null || timeStr == '' || timeStr == undefined) { return ""; }
		function add0 (m) {
			return m < 10 ? ('0' + m) : m;
		}
	...
	logout: function () {
		...
		// window.location.href= $.interfacePath.server + 'ftb-web/template/basic/login.html';
		window.location.href = $.interfacePath.loginUrl;
	},
